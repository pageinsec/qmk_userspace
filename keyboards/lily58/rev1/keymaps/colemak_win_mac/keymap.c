 ...
 */
 ...
 [_COLEMAKM] = LAYOUT(
  ...
  KC_GRAVE, LGUI_T(KC_Z),   KC_X,           KC_C,           LSFT_T(KC_V),     LT(4, KC_B),          LCA_T(KC_MINUS),   MEH_T(KC_MINUS), KC_K,               RSFT_T(KC_M),   KC_COMM,        KC_DOT,         RGUI_T(KC_SLSH), CW_TOGG,
                                            KC_DEL,         KC_LEFT,          LALT_T(KC_RIGHT),     LT(2, KC_SPC),     LT(3, KC_ENT),   RALT_T(KC_DOWN),    KC_UP,          KC_ESC
),
/* LOWER
...
[_LOWER] = LAYOUT(
  ...
  KC_AMPR, KC_PERC, KC_CIRC, KC_LBRC, KC_RBRC, S(KC_MINUS), LALT(KC_F4), RALT(KC_F4),   S(KC_MINUS),  KC_P1, KC_P2, KC_P3,  KC_SLSH, KC_COLN,
